...
describe("DOM helpers", function() {
  ...
  describe("addClass()", function() {
    ...
    context("create a <div>", function() {
      ...
      context("run addClass(div, hello)", function() {
        beforeEach(function() {
    ...
    context("create a <div class=hello>", function() {
      ...
      context("run addClass(div, world)", function() {
        beforeEach(function() {
  ...
  describe("removeClass()", function() {
    ...
    context("create a <div class=hello>", function() {
      ...
      context("run removeClass(hello)", function() {
        beforeEach(function() {
          removeClass(this.div, "hello");
        });
        it("should not have hello"); // hasClass() doesn't work if className is empty;
      });
    });
    ...
    context("create a <div class=hello world>", function() {
      ...
      context("run removeClass(world)", function() {
        beforeEach(function() {
